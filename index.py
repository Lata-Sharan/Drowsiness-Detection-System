...
def d_dtcn():
	...
	Button(root,text="Run using phone cam",font=("times new roman",20),bg="#0D47A1",fg='white',command=function1).grid(row=7,columnspan=5,sticky=W+E+N+S,padx=5,pady=5)
